                                                ...
                                                <div class="mt-4 row">
                                                    <div class="col-md-8">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <select class="w-100 p-1 alert alert-primary" name="investment_type_id"
                                                                onchange="location.href = '/dashboard/create_investment/'+this.value"
                                                                    id="">
                                                                    <option value="{{$selectedType->id}}">{{$selectedType->package}}</option>
                                                                    @foreach($investmentTypes as $type)
                                                                    <option onclick="alert('')" value="{{$type->id}}">{{$type->package}}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="mt-5">
                                                                    <div class="">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <div>
                                                                            <input type="number" required
                                                                                ...
                                                                                placeholder="1000" min="{{$selectedType->min}}"
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="mb-3 col-md-6">
                                                                        ...
                                                                        <span class="text-primary small">{{$selectedType->package}}</span>
                                                                    </div>
                                                                    <div class="mb-3 col-md-6">
                                                                        <p class="mb-0 small">Duration</p>
                                                                        <span class="text-primary small">{{ucfirst($selectedType->duration)}}</span>
                                                                    </div>
                                                                    <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <div class="mb-3 col-md-6">
                                                                        ...
                                                                        <span class="text-primary small">${{$selectedType->min}}</span>
                                                                    </div>
                                                                    <div class="mb-3 col-md-6">
                                                                        <p class="mb-0 small">Maximum Deposit</p>
                                                                        <span class="text-primary small">${{$selectedType->max}}</span>
                                                                    </div>
                                                                </div>
                                                                <hr>
