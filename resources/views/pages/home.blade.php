            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <img src="https://th.bing.com/th?id=OIP.jmMZ3KmPj_dpKJSZqs24awHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2" wi alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
                                                <img src="https://th.bing.com/th/id/OIP.R7F7gPjhD8LNiWX0TQMWcAHaHa?w=189&h=189&c=7&r=0&o=5&pid=1.7" width="30%" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
                                           <img src="https://th.bing.com/th/id/OIP.OLy4F-_ObGuJwZ5ZP_Ja8AHaD4?w=338&h=180&c=7&r=0&o=5&pid=1.7" width="30%" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-white icon bg-gradient-primary rounded-circle icon-shape">
                                               <img src="https://th.bing.com/th/id/OIP.ulJoL56Bq2qzxj75nHz88AHaHa?w=218&h=218&c=7&r=0&o=5&pid=1.7" width="30%" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mt-4 row ">
                        <div class="col-12">
                            <div class="nk-block-head-content">
                                ...
                                <h5 class="text-primary h5">Active Plan(s) <span class="text-base count">(0)</span></h5>
                            </div>
                        </div>
                        <div class="col-12">
                                                            <div class="mt-4 row">
                    ...
                    <div class="mt-4 row">
                        <div class="col-12">
                            <div class="nk-block-head-content">
                                <h6 class="text-primary h5">Recent transactions <span class="text-base count">(0)</span>
                                </h6>
                            </div>
                        </div>
                        <div class="col-12">
